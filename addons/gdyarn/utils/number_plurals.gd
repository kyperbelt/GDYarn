...
# for use with expanding format static functions
static func plural_case_string(pcase: int) -> String:
...
# yo, yue, zh
static func __get_plural_case_0(value: float) -> int:
	return PluralCase.Other


# am, as, bn, fa, gu, hi, kn, zu
static func __get_plural_case_1(value: float) -> int:
	var v = int(abs(value))
	if v == 0 || v == 1:
...
# ff, fr, hy, kab
static func __get_plural_case_2(value: float) -> int:
	var v := int(value)
...
# pt
static func __get_plural_case_3(value: float) -> int:
	var v := int(value)
...
# en
static func __get_plural_case_4(value: float) -> int:
	var i = int(value)
...
static func __get_plural_case_5(value: float) -> int:
	var n = abs(value)
	var i = int(value)
...
static func __get_plural_case_6(value: float) -> int:
	var n := int(abs(value))
	if n >= 0 && n <= 1:
		return PluralCase.One
...
static func __get_plural_case_7(value: float) -> int:
	var n := int(abs(value))
...
static func __get_plural_case_8(value: float) -> int:
	var n := int(abs(value))
	if n == 1:
		return PluralCase.One
	return PluralCase.Other
...
static func __get_plural_case_9(value: float) -> int:
	var n := abs(value)
	var i := int(value)
	var f := get_fraction(value)
...
static func __get_plural_case_10(value: float) -> int:
	var i := int(value)
	var f := get_fraction(value)
...
static func __get_plural_case_11(value: float) -> int:
	var i = int(value)
	var v = step_decimals(value)
	var f = get_fraction(value)
...
static func __get_plural_case_12(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
	var f := get_fraction(value)
	if (
...
static func __get_plural_case_13(value: float) -> int:
	var n := int(abs(value))
	var v := step_decimals(value)
	var f := get_fraction(value)
...
static func __get_plural_case_14(value: float) -> int:
	var n := abs(value)
	var i := int(value)
...
static func __get_plural_case_18(value: float) -> int:
	var n := int(abs(value))
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_19(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
	var f := get_fraction(value)
...
static func __get_plural_case_20(value: float) -> int:
	var n := abs(value)
...
static func __get_plural_case_21(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_22(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
	var f := get_fraction(value)
...
static func __get_plural_case_23(value: float) -> int:
	var n := int(abs(value))
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_24(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_25(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_26(value: float) -> int:
	var n := int(abs(value))
...
static func __get_plural_case_27(value: float) -> int:
	var n := int(abs(value))
	var f := get_fraction(value)
...
static func __get_plural_case_28(value: float) -> int:
	var n := int(abs(value))
	if n == 1:
		return PluralCase.One
...
static func __get_plural_case_29(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_30(value: float) -> int:
	var n := int(abs(value))
...
static func __get_plural_case_31(value: float) -> int:
	var n := abs(value)
	if n == 1:
		return PluralCase.One
	if n == 2:
...
static func __get_plural_case_32(value: float) -> int:
	var i := int(value)
	var v := step_decimals(value)
...
static func __get_plural_case_33(value: float) -> int:
	var n := int(abs(value))
...
static func __get_plural_case_34(value: float) -> int:
	var n := int(abs(value))
...
static func __get_plural_case_35(value: float) -> int:
	var n := abs(value)
	if n == 0:
		return PluralCase.Zero
	if n == 1:
...
static func get_plural_case(locale: String, value: float) -> int:
	match locale:
...
static func __get_ordinal_case_36(value: float) -> int:
	return PluralCase.Other


static func __get_ordinal_case_37(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_38(value: float) -> int:
	var n := int(abs(value))
	if n == 1:
		return PluralCase.One
	return PluralCase.Other
...
static func __get_ordinal_case_39(value: float) -> int:
	var n := int(abs(value))
	if n == 1 || n == 5:
		return PluralCase.One
	return PluralCase.Other
...
static func __get_ordinal_case_40(value: float) -> int:
	var n := int(abs(value))
	if n >= 1 && n <= 4:
		return PluralCase.One
	return PluralCase.Other
...
static func __get_ordinal_case_41(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_42(value: float) -> int:
	var n := int(abs(value))
	if n % 10 == 3 && !(n % 100 == 13):
		return PluralCase.Few
	return PluralCase.Other
...
static func __get_ordinal_case_43(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_44(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_45(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_46(value: float) -> int:
	var i = int(value)
	if i == 1:
		return PluralCase.One
	if (
...
static func __get_ordinal_case_47(value: float) -> int:
	var n := int(abs(value))
	if n == 1:
		return PluralCase.One
	if n % 10 == 4 && !(n % 100 == 14):
...
static func __get_ordinal_case_48(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_49(value: float) -> int:
...
static func __get_ordinal_case_50(value: float) -> int:
	var n := int(abs(value))
	if n == 1:
		return PluralCase.One
...
static func __get_ordinal_case_51(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_52(value: float) -> int:
	var n := int(abs(value))
	if n == 1 || n == 3:
		return PluralCase.One
	if n == 2:
...
static func __get_ordinal_case_53(value: float) -> int:
	var i := int(value)
...
static func __get_ordinal_case_54(value: float) -> int:
	var i := int(value)
	if (
		(
			((i % 10) == 1)
...
static func __get_ordinal_case_55(value: float) -> int:
	var n := int(abs(value))
	if n == 1:
		return PluralCase.One
	if n == 2 || n == 3:
...
static func __get_ordinal_case_56(value: float) -> int:
	var n := int(abs(value))
...
static func __get_ordinal_case_57(value: float) -> int:
	var n := int(abs(value))
	if n == 1 || n == 5 || (n >= 7 && n <= 9):
		return PluralCase.One
	if n == 2 || n == 3:
...
static func __get_ordinal_case_58(value: float) -> int:
	var n := int(abs(value))
...
static func get_ordinal_case(locale: String, value: float) -> int:
	match locale:
...
static func get_fraction(value: float) -> int:
